...
// Importar la interfaz de Chainlink Price Feed
...
contract RoleContract {
    ...
    function eliminarAdministrador(address _admin) 
        ...
        direccionValida(_admin) 
    {
        if (_admin == propietario) {
            revert("El propietario no puede ser eliminado como administrador");
        }
        ...
        direccionValida(nuevoPropietario) 
    {
        ...
        administradores[nuevoPropietario] = true;
        
        // El viejo propietario sigue siendo administrador
